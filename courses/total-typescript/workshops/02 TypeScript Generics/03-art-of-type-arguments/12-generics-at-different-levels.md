---
created: 2024-07-28T11:02
updated: 2024-07-28T11:08
---
# Problem

```ts file:12-generics-at-different-levels.problem.ts
...
```ts file:12-generics-at-different-levels.solution.1.ts fold
import { expect, it, describe } from "vitest";
import { Equal, Expect } from "../helpers/type-utils";
...
```ts file:12-generics-at-different-levels.solution.2.ts fold
